...
import { WhereBuyComposer } from '../communication/messages/outgoing/djinn/items/WhereBuyComposer';
    ...
    public sessionUpdate(id: number, type: string): void
    {
        ...
        switch (type)
        {
            ...
            case RoomSessionHandler.RS_READY:
                Nitro.instance.communication.connection.send(new WhereBuyComposer());
                return;
