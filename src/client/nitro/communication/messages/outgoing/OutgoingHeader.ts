export class OutgoingHeader
{
    ...
    public static DJINN_WHERE_BUY_COMPOSER = 9900;
    public static DJINN_EMPTY_ITEMS_COMPOSER = 9901;
    public static DJINN_WHISPER_GROUP_COMPOSER = 9902;
    public static DJINN_WHISPER_GROUP_OP_COMPOSER = 9903;
}
